...
function playMusic(){
  ...
  //document.querySelector('.img-area').classList.add('spinning');
  mainAudio.play();
}
...
function pauseMusic(){
  ...
  let style = window.getComputedStyle(imgArea);
  let transform = style.getPropertyValue("transform");

  wrapper.classList.remove("paused");
  playPauseBtn.querySelector("i").innerText = "play_arrow";
  document.querySelector('.img-area').classList.remove('spinning');
  imgArea.style.transform = transform; // apply the current rotation
  mainAudio.pause();
}
...
// toggle favorite button in song list event
togglefavBtn.addEventListener("click", () => {
  const isFav = togglefavBtn.innerText === "star";
  isFav ? togglefavBtn.innerText = "queue_music" : togglefavBtn.innerText = "star";
});
